...
- [ ] 4.10 **F2 fossil-by-design — DO NOT TOUCH.** `src/renderer/features/automations/automations-detail-view.tsx:847` (`new Date(execution.created_at)`) is in F2 (Automations & Inbox) territory, fully upstream-dependent. Tracked under the F2 restoration roadmap in `.scratchpad/upstream-features-inventory.md`
