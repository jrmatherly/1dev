...
| shiki | 4.0.2 | Upgraded from 3.x on 2026-04-10 via `upgrade-shiki-4` OpenSpec change. The `@pierre/diffs` peer-dep block on shiki 3.x was worked around during the upgrade. |
