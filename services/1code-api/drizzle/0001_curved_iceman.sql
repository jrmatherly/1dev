CREATE TYPE "public"."key_status" AS ENUM('active', 'revoked', 'rotated', 'expired', 'expiring_soon');
...
--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "litellm_user_id" text;
--> statement-breakpoint
ALTER TABLE "users"
ADD COLUMN "is_active" boolean DEFAULT true NOT NULL;
--> statement-breakpoint
ALTER TABLE "users"
ADD COLUMN "default_key_duration_days" integer DEFAULT 90 NOT NULL;
--> statement-breakpoint
ALTER TABLE "users"
ADD COLUMN "deprovisioned_at" timestamp
with
    time zone;
--> statement-breakpoint
ALTER TABLE "provisioned_keys" ADD CONSTRAINT "provisioned_keys_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "provisioned_keys" ADD CONSTRAINT "provisioned_keys_rotated_from_id_provisioned_keys_id_fk" FOREIGN KEY ("rotated_from_id") REFERENCES "public"."provisioned_keys"("id") ON DELETE set null ON UPDATE no action;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX "uq_user_team" ON "user_team_memberships" USING btree ("user_id", "team_id");
--> statement-breakpoint
