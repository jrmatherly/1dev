...
- **TS baseline:** ~87 pre-existing errors. Only worry about new errors your changes introduce. See [`.claude/rules/tscheck-baseline.md`](.claude/rules/tscheck-baseline.md).
