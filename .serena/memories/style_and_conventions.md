...
- Current baseline: 45 pre-existing errors (stored in `.claude/.tscheck-baseline`) — improved from 80 via SonarLint remediation + Cluster A `DiffStateContextValue` type alignment 2026-04-10
