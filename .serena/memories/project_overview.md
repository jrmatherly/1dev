...
- 15 regression guards + 19 service test files in `services/1code-api/tests/` = 172 tests across 34 files (162 pass + 10 skipped integration tests needing docker-compose harness, 2026-04-11)
