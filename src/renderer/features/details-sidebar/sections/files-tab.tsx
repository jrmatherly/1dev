      ...
      <ContextMenu>
        ...
        <ContextMenuContent className="w-52">
          {!isFolder && (
            <>
              <ContextMenuItem
                onClick={() => onContextAction("open-preview", node)}
              >
                Open Preview
              </ContextMenuItem>
              <ContextMenuSeparator />
          ...
          <ContextMenuItem
            onClick={() => onContextAction("reveal-finder", node)}
          >
            Reveal in Finder
          </ContextMenuItem>
          <ContextMenuSeparator />
          ...
          <ContextMenuItem
            onClick={() => onContextAction("copy-relative", node)}
          >
            Copy Relative Path
          </ContextMenuItem>
          <ContextMenuSeparator />
    ...
    const handleRenameSave = useCallback(
      async (newName: string) => {
        ...
        try {
          ...
          const newRelativePath = parentDir
            ? parentDir + "/" + newName
            : newName;
          ...
          setFocusedPath((prev) => {
            ...
            if (prev.startsWith(oldPath + "/"))
              return newRelativePath + prev.slice(oldPath.length);
            return prev;
          });
