  ...
  return (
    <ContextMenu>
      ...
      <ContextMenuContent className="w-48">
        ...
        <ContextMenuItem
          onClick={() => onRename({ id: card.chatId, name: card.name })}
        >
          Rename workspace
        </ContextMenuItem>
        {card.branch && (
        ...
        <ContextMenuSub>
          ...
          <ContextMenuSubContent sideOffset={6} alignOffset={-4}>
            <ContextMenuItem
              onClick={() =>
                onExportChat({ chatId: card.chatId, format: "markdown" })
              }
            >
            ...
            <ContextMenuItem
              onClick={() =>
                onExportChat({ chatId: card.chatId, format: "json" })
              }
            >
              Download as JSON
            </ContextMenuItem>
            <ContextMenuItem
              onClick={() =>
                onExportChat({ chatId: card.chatId, format: "text" })
              }
            >
              Download as Text
            </ContextMenuItem>
            ...
            <ContextMenuItem
              onClick={() =>
                onCopyChat({ chatId: card.chatId, format: "markdown" })
              }
            >
              Copy as Markdown
            </ContextMenuItem>
            <ContextMenuItem
              onClick={() =>
                onCopyChat({ chatId: card.chatId, format: "json" })
              }
            >
              Copy as JSON
            </ContextMenuItem>
            <ContextMenuItem
              onClick={() =>
                onCopyChat({ chatId: card.chatId, format: "text" })
              }
            >
              Copy as Text
            </ContextMenuItem>
        ...
        {typeof window !== "undefined" && window.desktopApi && (
          <ContextMenuItem
            onClick={() =>
              window.desktopApi?.newWindow({ chatId: card.chatId })
            }
          >
            Open in new window
          </ContextMenuItem>
