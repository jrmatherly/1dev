...
// Note: `Selection.getComposedRanges` is now part of the standard DOM lib
// (Chromium 137+). No polyfill block required.
      ...
      rafId = requestAnimationFrame(() => {
        ...
        if (element) {
          ...
          if (fileViewerElement) {
            const filePath =
              fileViewerElement.getAttribute("data-file-viewer-path") ||
              "unknown";
          ...
          if (!source && planElement) {
            const planPath =
              planElement.getAttribute("data-plan-path") || "unknown";
          ...
          if (!source && toolEditElement) {
            ...
            const filePath =
              toolEditElement.getAttribute("data-tool-file-path") || "unknown";
