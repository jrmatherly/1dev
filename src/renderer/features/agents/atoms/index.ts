...
const diffSidebarOpenStorageAtom = atomWithWindowStorage<
  Record<string, boolean>
>("agents:diffSidebarOpen", {}, { getOnInit: true });
...
const planSidebarOpenStorageAtom = atomWithWindowStorage<
  Record<string, boolean>
>("agents:planSidebarOpen", {}, { getOnInit: true });
...
export const workspaceDiffCacheAtomFamily = atomFamily((chatId: string) =>
  atom(
    ...
    (
      ...
      const newCache =
        typeof update === "function" ? update(prevCache) : update;
...
export const automationTemplateParamsAtom =
  atom<AutomationTemplateParams>(null);
