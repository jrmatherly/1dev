...
export function createQueueItem(
  ...
  return {
    ...
    textContexts:
      textContexts && textContexts.length > 0 ? textContexts : undefined,
    diffTextContexts:
      diffTextContexts && diffTextContexts.length > 0
        ? diffTextContexts
        : undefined,
    pastedTexts:
...
export function toQueuedTextContext(
...
export function toQueuedDiffTextContext(
  ctx: DiffTextContext,
