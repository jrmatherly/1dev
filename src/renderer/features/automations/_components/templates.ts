...
export const AUTOMATION_TEMPLATES: AutomationTemplate[] = [
  {
    ...
    description:
      "Automatically analyze and enrich new GitHub issues with relevant context.",
  ...
  },
  {
    ...
    description:
      "Automatically review pull requests for code quality and best practices.",
  ...
  },
  {
    ...
    triggerType: "pr_opened",
    description:
      "Automatically generate PR descriptions based on the changes made.",
