      ...
      <div className="max-w-2xl mx-auto p-6 space-y-5">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-[11px] text-muted-foreground">
            Will be converted to kebab-case (lowercase letters, numbers,
            hyphens)
          </p>
        </div>
...
export function AgentsSkillsTab() {
  ...
  const handleDelete = useCallback(async () => {
    ...
    try {
      ...
      toast.success(
        `${deletingItem.kind === "skill" ? "Skill" : "Command"} deleted`,
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <strong>{deletingItem?.name}</strong>? This will remove the file
