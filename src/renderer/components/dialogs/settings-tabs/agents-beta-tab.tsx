...
export function AgentsBetaTab() {
  ...
  const [automationsEnabled, setAutomationsEnabled] = useAtom(
    betaAutomationsEnabledAtom,
  );
  const [betaUpdatesEnabled, setBetaUpdatesEnabled] = useAtom(
    betaUpdatesEnabledAtom,
  );
      ...
      {!isNarrowScreen && (
        <div className="flex flex-col space-y-1.5 text-center sm:text-left">
          ...
          <p className="text-xs text-muted-foreground">
            Enable experimental features. These may be unstable or change
            without notice.
          </p>
        </div>
      )}
        ...
        <div className="bg-background rounded-lg border border-border overflow-hidden">
          <div className="flex items-center justify-between p-4">
            <div className="flex flex-col space-y-1">
              ...
              <span className="text-xs text-muted-foreground">
                Receive beta versions before they're released to everyone. Beta
            ...
            <Switch
              ...
              onCheckedChange={(checked) => {
                ...
                window.desktopApi?.setUpdateChannel(
                  checked ? "beta" : "latest",
                );
              }}
            />
